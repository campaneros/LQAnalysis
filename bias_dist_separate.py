    ...
    for function_gen, function_fit in itertools.product(fitting_function, fitting_function):
        ...
        for cat in categories:
            ...
            for m,l in tasks:
                ...
                inputfile ="../Fit_Signal/output_MC/gen_"+function_gen+"_fit_"+function_fit+"/datacard_"+fit_fucntion_name_gen+"_umuLQumu_M"+str(m)+"_L"+str(l)+"_"+cat+"_t_"+str(t)+"_syst0_seed123456/higgsCombine_toys"+str(t)+"_expectSignal"+str(exp)+"_std_4par.MultiDimFit.mH120.123456.root"
            ...
            for ext in ['png', 'pdf','C']:
                c1.SaveAs("%s/bias_signal_%s_%s_%s.%s"%(opt.outputdir, function_gen, function_fit, cat, ext))
            outputfile.cd()
