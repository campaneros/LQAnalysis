...
parser.add_option("-t", "--toysfile", dest="toysfile", default="/data/mcampana/CMS/CMSSW_8_1_0_LQ/src/Fit_Signal/output_MC/datacard_LQumu_M1000_L0p1_category1Muon_t_1_syst0_seed1123456/higgsCombine_toys1_expectSignal0.GenerateOnly.mH120.1123456.root",
                  help="input file with fitted toys")

parser.add_option("-f", "--fitfile", dest="fitfile", default="/data/mcampana/CMS/CMSSW_8_1_0_LQ/src/Fit_Signal/output_MC/datacard_LQumu_M1000_L0p1_category1Muon_t_1_syst0_seed1123456/higgsCombine_toys1_expectSignal0_gen.MultiDimFit.mH120.1123456.root",
