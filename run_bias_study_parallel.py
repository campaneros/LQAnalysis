...
def run_bias_study(args):
    ...
    limit = 100*float(cwd_utils.nested_dict_limit["limit_dict_%s"%l]["%s"%m])
    ...
    for function_gen, function_fit in itertools.product(fitting_function, fitting_function):
     ...
     os.system("python bias_study.py -d /data/mcampana/CMS/CMSSW_8_1_0_LQ/src/Fit_Signal_BDT_data_all/new_umu_datacards_finalcat_"+function_gen+"_450/umuLQumu_M"+str(m)+"_L"+str(l)+"/categories/datacard_"+fit_fucntion_name_gen+"_umuLQumu_M"+str(m)+"_L"+str(l)+"_"+category+".txt -g /data/mcampana/CMS/CMSSW_8_1_0_LQ/src/Fit_Signal_BDT_data_all/new_umu_datacards_finalcat_"+function_fit+"_450/umuLQumu_M"+str(m)+"_L"+str(l)+"/categories/datacard_"+fit_fucntion_name_fit+"_umuLQumu_M"+str(m)+"_L"+str(l)+"_"+category+".txt -t "+str(toy)+" --expectSignal "+str(exp)+" -l "+str(limit)+" --gen 1 -o /data/mcampana/CMS/CMSSW_8_1_0_LQ/src/Fit_Signal/output_MC/umu_gen_"+function_gen+"_fit_"+function_fit+"")
     os.system("python plot_bias.py -i ../Fit_Signal/output_MC/umu_gen_"+function_gen+"_fit_"+function_fit+"/datacard_"+fit_fucntion_name_gen+"_umuLQumu_M"+str(m)+"_L"+str(l)+"_"+category+"_t_"+str(toy)+"_syst0_seed123456/higgsCombine_toys"+str(toy)+"_expectSignal"+str(exp)+"_std_4par.MultiDimFit.mH120.123456.root -o ../Fit_Signal_BDT_tests/output_MC/test_STD_2/ -f umu_fit_"+function_fit+"_gen_"+function_gen+"_toys"+str(toy)+"_"+category+"_expect"+str(exp)+"_"+str(m)+"_"+str(l)+" -r "+str(exp)+"")
    # print("python plotSimultaneousFit_toy_singlecat.py -t /data/mcampana/CMS/CMSSW_8_1_0_LQ/src/Fit_Signal/output_MC/umu_gen_"+function_gen+"_fit_"+function_fit+"/datacard_"+fit_fucntion_name_gen+"_umuLQumu_M"+str(m)+"_L"+str(l)+"_"+category+"_t_"+str(toy)+"_syst0_seed123456/higgsCombine_toys"+str(toy)+"_expectSignal0.GenerateOnly.mH120.123456.root -f /data/mcampana/CMS/CMSSW_8_1_0_LQ/src/Fit_Signal/output_MC/umu_gen_"+function_gen+"_fit_"+function_fit+"/datacard_"+fit_fucntion_name_gen+"_umuLQumu_M"+str(m)+"_L"+str(l)+"_"+category+"_t_"+str(toy)+"_syst0_seed123456/higgsCombine_toys"+str(toy)+"_expectSignal"+str(exp)+"_std_4par.MultiDimFit.mH120.123456.root -n "+ str(toy)+" -o /data/mcampana/CMS/CMSSW_8_1_0_LQ/src/Fit_Signal/output_MC/plotSimFit_test/umuLQumu_"+str(m)+"_L"+str(l)+"_"+category+" -F "+function_fit+" -b expect_signal_0_"+function_fit+" -c /data/mcampana/CMS/CMSSW_8_1_0_LQ/src/Fit_Signal_BDT_data_all/new_umu_datacards_finalcat_STD_450/ -W /data/mcampana/CMS/CMSSW_8_1_0_LQ/src/Fit_Signal_BDT_data_all/newsample_output_MC_finalcat_"+function_gen+"_450/workspace_"+function_gen+".root")
